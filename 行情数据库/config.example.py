...
# -*- coding: utf-8 -*-
"""
量学系统统一配置中心 - 示例模板（v3.7）
========================================
请将此文件复制为 config.py 并填入真实数据
...
HOLDINGS: Dict[str, StockInfo] = {
    'sh603516': StockInfo(name='淳中科技', cost=None, shares=0,
                          stop_loss=None, life_line=None),
    'sh601138': StockInfo(name='工业富联', cost=None, shares=0),
    'sz002156': StockInfo(name='通富微电', cost=None, shares=0),
    'sh601231': StockInfo(name='环旭电子', cost=None, shares=0),
    'sz300476': StockInfo(name='胜宏科技', cost=None, shares=0,
                          take_profit=(None, None)),
    'sh603283': StockInfo(name='赛腾股份', cost=None, shares=0),
}
...
def validate_config() -> None:
    ...
    for code, info in HOLDINGS.items():
        ...
        if info.take_profit is not None and info.take_profit[0] is not None:
